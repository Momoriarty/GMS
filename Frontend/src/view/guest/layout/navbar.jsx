    ...
    <nav className="flex items-center justify-between px-8 py-4 bg-[#07090f]/70 backdrop-blur-xl border-b border-white/[0.06] sticky top-0 z-20">
      ...
      <div className="hidden md:flex items-center gap-7">
        {["Beranda", "Event", "Jadwal", "Leaderboard", "Tentang"].map((item) => (
          <a
            key={item}
            className="text-white/60 text-[13px] font-semibold tracking-wide no-underline cursor-pointer hover:text-white transition-colors duration-200"
          >
            {item}
          </a>
        ))}
