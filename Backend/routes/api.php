...
// ── QRIS (public: generate dynamic QR for payment) ──────────────────
Route::post('/qris/generate', [\App\Http\Controllers\Api\QrisSettingsController::class, 'generate']);

// Existing routes continued
Route::post('/webhook-gopay', [PendaftaranController::class, 'webhookGopay']);
...
Route::middleware('auth:sanctum')->group(function () {
    ...
    // QRIS Settings (admin)
    Route::get('/admin/qris/settings', [\App\Http\Controllers\Api\QrisSettingsController::class, 'show']);
    Route::post('/admin/qris/settings', [\App\Http\Controllers\Api\QrisSettingsController::class, 'store']);
});
