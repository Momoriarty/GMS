        ...
        <div className="min-h-screen bg-[#0f172a] text-white font-sans">
            ...
            <nav className="flex items-center justify-between px-10 py-6 absolute w-full z-20">
                ...
                <div className="hidden md:flex gap-8 text-sm font-medium">
                    <a href="#" className="text-blue-400">Beranda</a>
                    <a href="#" className="hover:text-blue-400 transition">Event</a>
                    <a href="#" className="hover:text-blue-400 transition">Jadwal</a>
                    <a href="#" className="hover:text-blue-400 transition">Hasil</a>
                </div>
            ...
            <section className="relative h-screen flex items-center px-10">
                ...
                <div className="relative z-10 max-w-3xl">
                    ...
                    <p className="text-gray-400 text-lg mb-8 max-w-xl">
                        Kelola turnamen, daftarkan tim, dan pantau jadwal
                        pertandingan secara profesional di seluruh Indonesia.
                    </p>
                ...
                <div className="grid grid-cols-1 md:grid-cols-4 gap-12">
                    <div className="col-span-1">
                        ...
                        <p className="text-gray-400 text-xs leading-relaxed">
                            Platform manajemen event futsal dan sekolah sepak
                            bola profesional yang terpercaya di Indonesia.
                        </p>
                    </div>
                    <div>
                        <h4 className="font-bold mb-6 text-sm">Navigasi</h4>
                        <ul className="text-gray-400 text-xs space-y-3">
                            <li className="cursor-pointer hover:text-white transition">Beranda</li>
                            <li className="cursor-pointer hover:text-white transition">Event</li>
                            <li className="cursor-pointer hover:text-white transition">Jadwal</li>
                            <li className="cursor-pointer hover:text-white transition">Hasil Pertandingan</li>
                        </ul>
                    </div>
                    <div>
